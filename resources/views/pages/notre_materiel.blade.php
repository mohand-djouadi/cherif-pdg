...
@section('main')
    <!-- ======= Titel Page ======= -->
    @include('layouts.partials._page_Title', ['title' => 'NOTRE MATERIEL '])
    <!-- Titel Page -->
    ...
    <section id="projects" class="projects section">
        ...
        <div class="container section-header" data-aos="fade-up">
            <h2 class="">NOTRE MATERIEL </h2>

        </div><!-- End Section Title -->

        <div class="contai m-0  p-0" >
            ...
            @else
                    ...
                    <article class="card__article">
                        <img src="{{$materiel->img_path}}" alt="image" class="imgCard card__img">

                        <div class="card__data">
                           {{-- <span class="card__description">Vancouver Mountains, Canada</span> --}}
                           <h2 class="card__title">{{$materiel->titre}}</h2>
