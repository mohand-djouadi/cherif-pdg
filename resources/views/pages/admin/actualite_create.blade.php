        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class=" container-fluid ">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Ajouter une nouvelle actualité</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                                ...
                                <form method="POST" id="myForm" action="{{ route('admin.actualites.store') }}"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                <div class="col-md-8">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="exampleInputFile" class="require @error('Image') is-invalid @enderror">Image de couverture :</label>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="date_article" class=" require form-label @error('date') is-invalid @enderror">Date :</label>
                                                        <input  class="form-control" type="date"
                                                            id="date_article" name="date" value="{{ old('date') }}" >
                                                        @error('date')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea id="compose-textarea" name="contenu" class="form-control  @error('contenu') is-invalid @enderror" style="height: 300px"> {{ old('contenu') }} </textarea>
                                            @error('contenu')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
